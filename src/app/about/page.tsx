      ...
      <div className="max-xl bg-white flex-1">
        ...
        <main className="w-full md:w-3/4 mx-auto">
          <div className="py-8 px-6">
            ...
            <h3 className="font-semibold mt-4 mb-1">v2.1.0</h3>
            <ul className="list-disc ml-6 mb-2">
              <li>Added Professional or Freelance pricing and feature set</li>
              <li>Bug fizes for Twain Story Writer</li>
            </ul>
            ...
            <ul className="list-disc ml-6 mb-2">
              ...
              <li>Added Network relationships∆ to family in profile view</li>
            </ul>
            ...
            <ul className="list-disc ml-6 mb-2">
              <li>
                Added Import Recipe from URL feature when createing a new
                recipe.
              </li>
            </ul>
