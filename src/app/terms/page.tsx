      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h2>2. Use License</h2>
            <p>
              Permission is granted to temporarily access this application for
            ...
            <h2>4. Limitations</h2>
            <p>
              In no event shall the application owner or its suppliers be liable
              ...
              the use or inability to use the materials in this application,
              even if the application owner or an authorized representative has
            ...
            <p>
              ...
              which also governs your use of the application, to understand our
              practices.
            </p>

            <h2>6. Revisions</h2>
            <p>
              The application may revise these terms of service at any time
