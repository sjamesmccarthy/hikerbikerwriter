                        ...
                        <div key={app.path}>
                          ...
                          {hasSubmenu && isSubmenuOpen && (
                            <div className="bg-gray-50 border-t border-gray-200">
                              ...
                              {app.name === "Dev Tools" && (
                                <div className="px-8 py-2 text-xs text-gray-500 border-t border-gray-200 bg-gray-100">
                                  All data stored in local storage and
                                  considered temporary data stored in your
                                  browser so if you need to keep this be sure to
                                  Export using one of the options at the bottom
                                  of the page.
                                </div>
                              )}
                            </div>
